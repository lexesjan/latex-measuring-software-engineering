...
The COCOMO model has three different models which allow the software manager to
...
\begin{itemize}
  ...
  \item Detailed COCOMO model --- Yet again this model builds on top of the
    ...
    cost estimates are completed at every step of the waterfall model. This is
    the most accurate model available in the COCOMO models.
\end{itemize}
